        ...
        <div className="row">
          ...
          <div className="col-md-4 text-center">
            <div className="row align-items-center">
              ...
              <div className="col-12 text-center">
                <h4 className="estilo-titulo4"> Consultas
                </h4>
              </div>
            </div>
          ...
          <div className="col-md-4 text-center">
            <div className="row align-items-center">
              <div className="col-12 text-center">
                <img
                  src={IconoUbicacion}
                  alt="Ubicación"
                  className="fa-lg color-icono mt-md-5"
                />
              </div>
              <div className="col-12 text-center">
                <h4 className="estilo-titulo4"> Ubicación
                </h4>
              </div>
            </div>
            {/* Dirección y mapa */}
            ...
            <p
              className="estilo-link fw-bold cursor-pointer mb-4"
            ...
            <img src={IconoCode} alt="Código" className="fa-lg color-icono" />
            <div>
              <h4 className="estilo-titulo4">Equipo de desarrollo:</h4>
            </div>

            <div
              className="estilo-link fw-bold mt-md-4 mb-4 mb-md-0"
